...
@section('script')
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#col0_filter, #col1_filter, #col2_filter').keyup(function () {
          dataTable.draw();
      });
    ...
    $('#datatable-vendor-list').on('click', '.statusBtn', function (event) {
      ...
      let url         = "{{route('changeCustomerStatus')}}";
